...
function MessageAvailable({ cabinIdInput, startDateInput, endDateInput }) {
  ...
  useEffect(() => {
    ...
    const backgroundColor = colorMapping.theme["light"].backgroundColor[color];
    const textColor = colorMapping.theme["light"].textColor[color];
    const textShadowColor = colorMapping.theme["light"].textShadow[color];
  ...
  }, [controls, iconControls, color, Icon]);
